...
function gerarTimeline(dataBase) {
...
export default function OrderDetail() {
  ...
  const timeline = gerarTimeline(pedido.data);
    ...
    <Screen>
      ...
      >
        ...
        >
          ...
          <Image 
          source={showTimeline ? ICONS.up : ICONS.down}
              ...
              <View key={index} style={styles.timelineRow}>
                ...
                <View style={styles.timelineContent}>
                  ...
                  <Text style={styles.timelineDate}>
                    {formatarDataExtenso(step.data)},{" "}
                    {formatarHora(step.data)}
                  </Text>
                </View>
              </View>
            ))}
